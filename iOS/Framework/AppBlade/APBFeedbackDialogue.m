...
@interface APBFeedbackDialogue ()

@property (nonatomic, assign) BOOL closing;

@end

@implementation APBFeedbackDialogue
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        CGRect overlayFrame = CGRectMake(0, -textViewVerticalOffset, self.frame.size.width, self.frame.size.height + textViewVerticalOffset);
        ...
        self.dialogueView = [[APBFeedbackBackgroundView alloc] initWithFrame:CGRectMake(originX, 0, width, feedbackHeightMin)] ;
