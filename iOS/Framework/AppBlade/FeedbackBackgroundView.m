...
@implementation FeedbackBackgroundView
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGGradientRef gradient7 = CGGradientCreateWithColors(colorSpace, (CFArrayRef)CFBridgingRetain(gradient7Colors), gradient7Locations);
